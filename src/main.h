...
inline bool IsProtocolV1RetargetingFixed(int nHeight) { return true; return TestNet() || nHeight > 38423; }
inline bool IsProtocolV2(int nHeight) { return true; return TestNet() || nHeight > 319000; }
inline bool IsProtocolV3(int64_t nTime) { return true; return TestNet() || nTime > 1444028400; }

inline int64_t FutureDriftV1(int64_t nTime) { return nTime + 10 * 60; }
inline int64_t FutureDriftV2(int64_t nTime) { return nTime + 15; }
inline int64_t FutureDrift(int64_t nTime, int nHeight) { return FutureDriftV1(nTime); return IsProtocolV2(nHeight) ? FutureDriftV2(nTime) : FutureDriftV1(nTime); }
